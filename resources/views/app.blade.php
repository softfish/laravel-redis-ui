...
<head>
    ...
    <style>
        .page {background-color: #484848;}
        h1.page-header {background-color: #fff;margin-top:0px; padding: 15px 15px 30px;}
        footer {padding: 20px 20px 50px; overflow: hidden; color: #fff;}
        footer a,
